...
int americaddt(int x,int y, int pais){
	switch(pais){
		...
		case 12:
				if(ddt(188,529,158,524,149,508,x,y) ||ddt(150,508,165,470,186,515,x,y) ||ddt(186,515,211,492,194,478,x,y) ||ddt(194,478,227,452,214,432,x,y) ||ddt(160,486,161,438,207,353,x,y) ||ddt(160,440,167,419,216,407,x,y) ||ddt(169,416,167,404,172,399,x,y) ||ddt(172,399,172,393,178,385,x,y) ||ddt(178,381,173,362,177,355,x,y) ||ddt(177,355,176,345,185,332,x,y) ||ddt(186,329,193,329,186,341,x,y) ||ddt(190,327,188,309,197,304,x,y) ||ddt(197,304,197,304,200,293,x,y) ||ddt(208,286,210,286,218,289,x,y) ||ddt(222,296,222,293,226,287,x,y) ||ddt(235,289,273,316,268,310,x,y) ||ddt(234,289,235,289,268,309,x,y) ||ddt(268,327,274,316,267,329,x,y) ||ddt(226,312,301,318,304,317,x,y) ||ddt(304,321,300,315,304,315,x,y) ||ddt(306,324,301,328,301,330,x,y) ||ddt(298,324,287,337,287,341,x,y) ||ddt(284,331,299,327,273,359,x,y) ||ddt(268,331,290,333,268,328,x,y) ||ddt(203,304,204,395,202,305,x,y) ||ddt(165,440,245,387,237,436,x,y) ||ddt(238,422,214,437,239,422,x,y) ||ddt(274,386,284,402,284,402,x,y) ||ddt(272,420,247,417,255,313,x,y) ||ddt(252,409,182,421,194,456,x,y) ||ddt(229,426,195,356,202,296,x,y) ||ddt(234,294,232,346,206,293,x,y) ||ddt(183,354,236,360,172,435,x,y) ||ddt(203,439,209,364,196,358,x,y) ||ddt(230,408,253,340,211,305,x,y))
				{
					return 12;
				}
		case 13:
